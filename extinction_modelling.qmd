...
4.  (If we have time) Relative the life history parameters to the population trends

### 1. Getting life-history data
...
- Download data for your species, and select Tasmania only, have a look at the dataframe (**NOTE:** I will give you a cleaned data file for analysis later)
...
dat_one_spp |>
  ...
  geom_point(col = "grey") +
  geom_line(aes(group = site_code), col = "grey") +
  geom_abline(
